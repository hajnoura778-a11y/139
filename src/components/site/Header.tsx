...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-[#e8ded1] bg-[#fdfbf7]/90 backdrop-blur-md transition-all duration-300">
      <div className="container-page flex h-20 items-center justify-between px-4">
        ...
        <div className="flex items-center justify-start">
          ...
          >
            <img 
              ...
              fetchpriority="high"
            />
            <span className="text-sm md:text-base font-bold text-[#1a0f07] leading-tight tracking-tight border-r border-[#e8ded1] pr-3">
              منصة حماية المستهلك
            </span>
          </Link>
        </div>

        {/* المنتصف: القائمة الرئيسية رسمية بدون حاوية */}
        <nav 
        ...
        <div className="md:hidden flex items-center justify-end">
          <button
            type="button"
            className="grid h-11 w-11 place-items-center rounded-xl border border-[#d2c2b0] bg-white text-[#1a0f07] transition-colors hover:bg-[#f7f2eb] focus:outline-none"
